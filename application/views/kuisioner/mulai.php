	...
	<div class="row justify-content-center">
		...
		<div class="col-lg">
			...
			<div class="card o-hidden border-0 shadow-lg mt-3 mb-5">
						...
						<div class="col-lg">
							<div class="p-5">
								<div class="text-center">
									...
									<h1 class="h1 font-weight-bold text-gray-900 mb-3">Kuisioner Penelitian</h1>
								...
								<!-- Mulai -->
								<form class="kuisioner" method="post" action="<?= base_url('kuisioner/mulai')?>">
									<!-- Seksi 1 -->
									<div class="text-left">
									...
									<div class="text-left ml-4 mb-4">
										<table>
											...
											<tr>
												...
												<td>
													<div class="form-check">
														<input class="form-check-input" type="radio" name="jk" id="jk" value="1">
											...
											<tr>
												...
												<td>
													<div class="form-check">
														<input class="form-check-input" type="radio" name="jk" id="jk" value="2">
														<label class="form-check-label" for="jk">
															Perempuan
														</label>
													</div>
											...
											<tr>
												...
												<td>
													<div class="form-check">
														<input class="form-check-input" type="radio" name="motor" id="motor" value="1">
											...
											<tr>
												...
												<td>
													<div class="form-check">
														<input class="form-check-input" type="radio" name="motor" id="motor" value="2">
														<label class="form-check-label" for="motor">
															Bebek
														</label>
													</div>
											...
											<tr>
												...
												<td>
													<div class="form-check">
														<input class="form-check-input" type="radio" name="motor" id="motor" value="3">
														<label class="form-check-label" for="motor">
															Sport
														</label>
													</div>
										...
										<table class="table table-bordered">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="A2" id="A2" value="1" checked>
												...
												<tr>
													...
													<td>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="A3" id="A3" value="1" checked>
												...
												<tr>
													...
													<td>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="A4" id="A4" value="1" checked>
												...
												<tr>
													...
													<td>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="A5" id="A5" value="1" checked>
											...
											<tbody>
												<tr>
													...
													<td>
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B1" id="B1" value="3">
															<label class="form-check-label" for="B1">
																Cukup Berguna
															</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B1" id="B1" value="4" checked>
															<label class="form-check-label" for="B1">
																Berguna
															</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B1" id="B1" value="5">
															<label class="form-check-label" for="B1">
																Sangat Berguna
															</label>
														</div>
												...
												<tr>
													...
													<td>
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B2" id="B2" value="3">
															<label class="form-check-label" for="B2">
																Cukup Berguna
															</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B2" id="B2" value="4" checked>
															<label class="form-check-label" for="B2">
																Berguna
															</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B2" id="B2" value="5">
															<label class="form-check-label" for="B2">
																Sangat Berguna
															</label>
														</div>
												...
												<tr>
													...
													<td>
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B3" id="B3" value="4" checked>
															<label class="form-check-label" for="B3">
																Berguna
															</label>
														</div>
												...
												<tr>
													...
													<td>
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B4" id="B4" value="3">
															<label class="form-check-label" for="B4">
																Cukup Berguna
															</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B4" id="B4" value="4" checked>
															<label class="form-check-label" for="B4">
																Berguna
															</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B4" id="B4" value="5">
															<label class="form-check-label" for="B4">
																Sangat Berguna
															</label>
														</div>
												...
												<tr>
													...
													<td>
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B5" id="B5" value="3">
															<label class="form-check-label" for="B5">
																Cukup Berguna
															</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B5" id="B5" value="4" checked>
															<label class="form-check-label" for="B5">
																Berguna
															</label>
														</div>
														<div class="form-check">
															<input class="form-check-input" type="radio" name="B5" id="B5" value="5">
															<label class="form-check-label" for="B5">
																Sangat Berguna
															</label>
														</div>
											...
											<tbody>
												<tr>
													...
													<td>
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" name="C1" id="C1" value="4" checked>
															<label class="form-check-label" for="C1">
																Mudah
															</label>
														</div>
												...
												<tr>
													...
													<td>
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" name="C2" id="C2" value="4" checked>
															<label class="form-check-label" for="C2">
																Mudah
															</label>
														</div>
												...
												<tr>
													...
													<td>
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" name="C3" id="C3" value="4" checked>
															<label class="form-check-label" for="C3">
																Mudah
															</label>
														</div>
												...
												<tr>
													...
													<td>
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" name="C4" id="C4" value="4" checked>
															<label class="form-check-label" for="C4">
																Mudah
															</label>
														</div>
												...
												<tr>
													...
													<td>
														...
														<div class="form-check">
															<input class="form-check-input" type="radio" name="C5" id="C5" value="4" checked>
															<label class="form-check-label" for="C5">
																Mudah
															</label>
														</div>
				...
				<div class="copyright text-center my-auto card-footer">
