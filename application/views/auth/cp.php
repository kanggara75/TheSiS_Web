		...
		<div class="col-lg-7">
			<div class="card o-hidden border-0 shadow-lg my-5">
				<div class="card-body p-0">
                  ...
                  <h5 class="mb-4"><?= $this->session->userdata('reset_pass'); ?></h5>
								</div>
								...
								<form class="user" method="post" action="<?= base_url('auth/changePass')?>">
									...
									<div class="form-group">
										<input type="password" class="form-control form-control-user" id="password2" placeholder="Confirm New Password..." name="password2">
