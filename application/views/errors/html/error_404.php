...
<head>
	...
	<!-- css files -->
	<link href="http://47.254.213.228/apps/assets/css/404style.css" rel="stylesheet" type="text/css" media="all" />

	<!-- My Icon -->
	<link rel="icon" href="http://47.254.213.228/apps/assets/img/icon.png" />
</head>
...
<body>
	<div class="container demo-2">
		<div class="content">
			<div id="large-header" class="large-header">
				...
				<img src="http://47.254.213.228/apps/assets/img/owl.gif" alt="flashy" class="w3l" />
	...
	<!-- js files -->
	<script src="http://47.254.213.228/apps/assets/js/rAF.js"></script>
	<script src="http://47.254.213.228/apps/assets/js/demo-2.js"></script>
	<!-- /js files -->
</body>
